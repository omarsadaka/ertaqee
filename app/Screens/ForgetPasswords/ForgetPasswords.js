...
class ForgetPasswords extends Component {
      ...
      return (
        <View style={styles.MainView}>
          <View style={styles.FirstMainView}>
            <Text style={styles.forgetPassword}> {strings.forgetPassword}</Text>
            <Text style={styles.justEnterEmailAndpass}>
              {' '}
              {strings.chooseHowToRestore}
            </Text>
          </View>
      ...
      return (
        <View style={styles.MainView}>
          <View style={styles.FirstMainView}>
            ...
            <Text style={styles.justEnterEmailAndPass}>
              {' '}
              {strings.dontWorryRestorepassword}{' '}
              {RestoreByPhoneOrEmail ? strings.phoneNumber : strings.email}
            </Text>
          </View>

          <View style={[styles.SocendMainView, {height: hp('7%')}]}>
            <Text style={styles.label}>
              {this.state.RestoreByPhoneOrEmail
                ? strings.phoneNumber
                : strings.email}
            </Text>
            <View
  ...
  SubmitChangePassPost() {
    ...
    const MyFormData = new FormData();
    console.log('this.state.restoreEmail:' + this.state.restoreEmail);
    MyFormData.append('email', this.state.restoreEmail);
    ...
    try {
      fetch('https://www.demo.ertaqee.com/api/v1/password/reset', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
        },
...
const styles = StyleSheet.create({
  ...
  Header: {width: wp('100%'), marginTop: hp('7%'), height: hp('3%')},
  ThirdMainView: {
    alignItems: 'center',
    width: wp('100%'),
    marginTop: hp('4%'),
  ...
  restoreByPhone: {height: hp('3%'), fontFamily: fonts.normal},
  SocendMainView: {
    alignItems: 'center',
    width: wp('100%'),
    marginTop: hp('12%'),
  ...
  dontHaveAnAccount: {fontSize: hp('2%'), color: '#C2C2C2'},
  label: {
    fontFamily: fonts.normal,
    fontSize: hp('1.8%'),
    width: '90%',
